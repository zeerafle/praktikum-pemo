        ...
        body: ListView(
          ...
          children: [
            ...
            Container(
                ...
                child: Row(children: [
                  ClipRRect(
                    ...
                    child: Image.asset("assets/dr_agung_santoso_square.jpg"),
                  ),
                  SizedBox(
                    width: 14,
                  ),
            ...
            InkWell(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Icon(Icons.timer,
                                size: 16, color: Color(0xffa8c686)),
                            Text(
                              "08.00 - Selesai",
                              style: TextStyle(
                                  fontSize: 10, fontFamily: "PoppinsMedium"),
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (_) => DrChristinePalmer()));
              },
            ),
            SizedBox(
              height: 24,
